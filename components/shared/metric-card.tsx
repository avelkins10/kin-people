...
export function MetricCard({
  ...
  return (
    <div className="bg-[#0a0a0a] text-white p-6 rounded-sm flex flex-col justify-between h-40 group hover:ring-2 hover:ring-indigo-500 transition-all duration-300">
